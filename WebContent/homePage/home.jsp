				...
				<div class="newsContent">
						<div class="notice">
							<div class="fontnotice">
								...
								<a href="<%=urls %>/platform/view.jsp?flag=8bb801332e12443db89afc227f260c33" class="moreA"></a>
							</div>
							<div>
								<ul>
								<%
								...
								%>
									<li><a href="<%=urls %>/journal/viewJournalContent.jsp?id=<%=noticemap.get("ID") %>" style="width:300px;color: #000000;"><%=title %></a><span class="time"><%=time %></span></li>
									<%
									}
									%>
								</ul>
						...
						<div class="news">
							...
							<div class="newsImg"></div>新闻
								<a href="<%=urls %>/platform/view.jsp?flag=fe5ccf7fb99342e6a3032df2841e6dca" class="moreA" ></a>
							</div>
							<div>
								<ul>
									<%
									...
									%>
									<li><a href="<%=urls %>/journal/viewJournalContent.jsp?id=<%=newsmap.get("ID") %>"			 style="width:300px;color: #000000;"><%=title %></a><span class="time"><%=time %></span></li>
									<%
										}
									%>
								</ul>
