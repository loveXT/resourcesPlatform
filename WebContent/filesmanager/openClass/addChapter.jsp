<%@page import="org.apache.poi.hslf.record.CString"%>
...
<%
	//获取 courseId课程编号 mid专业编号 chapterId章节编号 
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#addChapterName").bind('blur',function(){
				...
				var url = "validateByAdd.jsp?TABLENAME=CHAPTER&WHERECOLUMN1=COURSE_ID&VALUE1=<%=courseId%>&WHERECOLUMN2=CHAPTER_NAME&VALUE2="+chapterName;
				$.ajax({
					url:url,
					type:"post",
			...
			$(".tool").toolBar([ {
				...
				handler : function() {
						var iii = $.trim($("[name='P=CHAPTER-1=CHAPTER_CODE=S=C']").val());;
						$("[name='P=CHAPTER-1=CHAPTER_CODE=S=C']").val(iii);
