...
<center class="sm_edit_center">
	<form class="sm_edit_from" method="post" action="updateFile.jsp" style="margin-top: 20px;">
...
<script type="text/javascript">
		...
		$(function() {
			...
			if("<%=bool%>"=="true"){
				var src = "listFile.jsp?Flag=<%=verifyStatus %>&POINT_ID=<%=POINT_ID%>&CHAPTER_ID=<%=CHAPTER_ID%>&COURSE_ID=<%=COURSE_ID%>&MAJOR_ID=<%=Major_id%>";
