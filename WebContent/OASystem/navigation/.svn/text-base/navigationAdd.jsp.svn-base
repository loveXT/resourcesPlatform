...
<div class="tool"></div>
	<form class="sm_edit_from" style="height: 180px;width: 365px;margin-top: 20px;margin-left: 80px;" method="post" action="">
		...
		<input type="hidden" name="P_NAVIGATION_ID_S_P" value="">
		<div class="sm_edit_tr"  style="width: 280px; " >
			...
			<input type="text" style="width: 260px;line-heihgt:30px;" class="maxLength:200num null" name="P_NAVIGATION_NAVIGATIONNAME_S_C" value=""></div>
		</div>
		<div class="sm_edit_tr"  style="width: 280px; " >
			<div class="sm_edit_td_name" style="height: 20px;line-heihgt:20px;">地址</div>
			<div class="sm_edit_td_value" >
			<input type="text" style="width: 260px;line-heihgt:30px;" class="null" name="P_NAVIGATION_ADDRESS_S_C" value=""></div>
		</div>
		<div class="sm_edit_tr"  style="height: 20px;width: 280px;" >
			...
			<div class="sm_edit_td_value" style="width: 100px;">
				<input type="text" style="width: 90px;line-heihgt:30px;" class=" null" name="P_NAVIGATION_PLSX_S_C" value="">
			</div>
			
			<div class="sm_edit_td_name" style="height: 20px;line-heihgt:30px;">是否隐藏</div>
			<div class="sm_edit_td_value" >
				是<input type="radio" class="null" name="P_NAVIGATION_STATE_S_C" value="0">
				否<input type="radio" class="null" name="P_NAVIGATION_STATE_S_C" checked="checked" value="1">
			</div>
		</div>
		<div class="sm_edit_tr"  style="height: 80px;width: 280px; " >
			<div class="sm_edit_td_name" style="height: 80px; ">菜单描述</div>
			<div class="sm_edit_td_value" >
			<textarea style="height: 80px;width: 262px;" class="maxLength:200num null" name="P_NAVIGATION_DESCRIPTION_S_C" ></textarea>
			</div>
		</div>	
	</form>
