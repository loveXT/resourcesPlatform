...
<body>
	...
	<form id="pageForm" class="sm_search" action="" method="post">
		...
		<input type="hidden" name="P_VERSION_ID_S_WD" value="">
	</form>
	<div class="sm_list">
		<!--列表  标题-->
		<table>
		...
		<table>
			<%
				...
				PageInfo pageInfo = versionManager.findPageInfoByVersionManager(nowPage, pageSize, "_", request);
				...
				handler : function() {
					...
					if($checkeds.length<1){
						...
						if(confirm("确认删除?")){
							...
							$("[name='P_VERSION_ID_S_WD']").val(ids.join("','"));
							$("#pageForm").submit();
						}
					}
				}
