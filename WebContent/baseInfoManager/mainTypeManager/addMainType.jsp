...
<div class="tool"></div>
	<form   class="sm_edit_from" style="height: 140px;width: 365px;margin-top: 40px;margin-left: 80px;" method="post" action="">
		...
		<input type="hidden" name="P_ZYMAINTYPE_ID_S_P" value="">
		<input type="hidden" name="P_ZYMAINTYPE_CREATETIME_D_C" value="">
		<div class="sm_edit_tr"  style="width: 280px; " >
			<div class="sm_edit_td_name">类型名称</div>
			<div class="sm_edit_td_value" >
			<input type="text" style="width: 260px;" class="maxLength:200num null" name="P_ZYMAINTYPE_TYPENAME_S_C" value="<%=request.getParameter("P_ZYMAINTYPE_TYPENAME_S_C")==null?"":request.getParameter("P_ZYMAINTYPE_TYPENAME_S_C")%>"></div>
		</div>
		<div class="sm_edit_tr"  style="height: 310px;width: 280px; " >
			<div class="sm_edit_td_name" style="height: 100px; ">描述</div>
			<div class="sm_edit_td_value" >
			<textarea style="height: 100px;width: 262px;" class="maxLength:200num null" name="P_ZYMAINTYPE_REMARK_S_C" ></textarea>
			</div>
		</div>	
	</form>
