...
Map map = chapterManager.findMapByID(id);
boolean bool = false;
...
<div class="tool"></div>
	<form   class="sm_edit_from" style="height: 140px;width: 365px;margin-top: 40px;margin-left: 80px;" method="post" action="">
		...
		<input type="hidden" name="P=CHAPTER=CHAPTER_ID=S=WU" value="<%=id%>">
		<div class="sm_edit_tr"  style="width: 280px; " >
			<div class="sm_edit_td_name">章节名称</div>
			<div class="sm_edit_td_value" >
			<input type="text" style="width: 260px;" class="maxLength:200num null" name="P=CHAPTER=CHAPTER_NAME=S=S" value="<%=Validate.isNullToDefault(map.get("CHAPTER_NAME"), "")%>"></div>
		</div>
		<div class="sm_edit_tr"  style="height: 310px;width: 280px; " >
			<div class="sm_edit_td_name" style="height: 100px; ">描述</div>
			<div class="sm_edit_td_value" >
			<textarea style="height: 100px;width: 262px;" class="maxLength:200num null" name="P=CHAPTER=REMARK=S=S" ><%=Validate.isNullToDefault(map.get("REMARK"), "")%></textarea>
			</div>
		</div>	
	</form>
