...
<script type="text/javascript">
	$(function(){
		$(".tool").toolBar([{}]);
		addIframe($(".right"),"operateResource","operateResource.jsp");
		setPageSize();
		//鼠标点击事件，未用
		$("[class^=tree_]").treeClick({
			handler:function(){
				var src = "operateResource.jsp";
				src += "?resourceId="+$(".tree_newColour").attr("id");
				$("#operateResource").attr("src",src);
			}
		});
