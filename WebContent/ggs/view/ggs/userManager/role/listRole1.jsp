		...
		<table>
			...
			<tr class="sm_copy_parent">
				...
				<td style="width: 100px;">
					<input type="text" id="xx<%=i + 1%>" value="<%=roleMap.get("ROLENAME")%>">
					<input type="hidden" id="xx<%=i + 1%>" value="">
				</td>
				<%
				...
				<td>
					<input class="sm_copy" type="button" value="">
				</td>
			</tr>
			<%
				}
