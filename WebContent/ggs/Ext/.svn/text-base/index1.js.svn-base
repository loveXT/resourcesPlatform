// JScript 文件
Ext.BLANK_IMAGE_URL =  "/JavaGDZC/ggs/Ext/resources/images/black/s.gif";
/*
页面树监听
*/
var listeners = {
   click:function(node, event){
        if (node.isLeaf()){
            ...
            if (p)
            {
                ...
                document.getElementById("iframe_"+id).contentWindow.location.href= node.attributes.url; 
...
//                    html:"<div id='div_ifram'style='width:100%;height:100%'><iframe frameborder='0' id='iframe_"+id+"' width='100%' height='100%' scrolling='auto' src='" + node.attributes.url+"'></iframe></div>"
                    html:"<iframe frameborder='0' id='iframe_"+id+"' width='100%' height='100%' scrolling='auto' src='" + node.attributes.url+"'></iframe>"
//                    ,listeners:{   
...
var disktop = new Ext.TabPanel({
    ...
    items: [{
           ...
           //iconCls:"index",
            autoScroll:true,
            html:"<iframe frameborder='0' id='iframe_desktop' width='100%' height='100%' scrolling='auto' src='ggs/view/ggs/homeManager/desktop.jsp'></iframe>",
            listeners:{   
                "activate":function(tab){  
                    //window.frames["iframe_"+tab.id].location.reload(); 
                    document.getElementById("iframe_"+tab.id).contentWindow.location.href='ggs/view/ggs/homeManager/desktop.jsp';    
                } 
            }
        }
      ] 
